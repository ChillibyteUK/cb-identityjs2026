...
```
git clone git@github.com:ChillibyteUK/cb-identityjs2026.git my-new-project
cd my-new-project
./setup.sh
```
...
renames every `cb-identityjs2026` / `CB Identity JS 2026` / `cb_identityjs2026_` /
`CB_Identity_JS_2026_` reference across the whole repo to match, and resets git to a
