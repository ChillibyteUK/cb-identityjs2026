...
/***/ "./blocks/contact-directory/src/edit.js"
/*!**********************************************!*\
  !*** ./blocks/contact-directory/src/edit.js ***!
  \**********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
function Edit({
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(_shared_EditorBlockShell__WEBPACK_IMPORTED_MODULE_3__["default"], {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
      ...
      help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Background colour is set via this block’s own Styles panel (Color → Background) — real source uses black for Email Groups, Neutral 1100 for Locations.', 'cb-identityjs2026'),
      onChange: value => setAttributes({
        mode: value
      })
    }), isEmails ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_shared_RepeaterField__WEBPACK_IMPORTED_MODULE_4__["default"], {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Groups', 'cb-identityjs2026'),
      layout: "column",
      value: groups,
      onChange: value => setAttributes({
        groups: value
      ...
      fields: [{
        name: 'entries',
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Entries (each with its own name + email) — no divider between entries in the same Group, only between Groups', 'cb-identityjs2026'),
        type: 'repeater',
        subLayout: 'row',
        subFields: [{
          name: 'name',
          label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Name', 'cb-identityjs2026'),
          type: 'text'
        }, {
          name: 'email',
          label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Email', 'cb-identityjs2026'),
          type: 'text'
        }, {
          name: 'phone',
          label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Phone', 'cb-identityjs2026'),
          type: 'text',
          help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Optional.', 'cb-identityjs2026')
        }],
        subEmptyRow: {
          name: '',
          email: '',
      ...
      fields: [{
        name: 'name',
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Office Name', 'cb-identityjs2026'),
        type: 'text'
      }, {
        name: 'addresses',
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Addresses', 'cb-identityjs2026'),
        type: 'repeater',
        subLayout: 'column',
        subFields: [{
          name: 'title',
          label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Sub-office Title', 'cb-identityjs2026'),
          type: 'text',
          help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Optional.', 'cb-identityjs2026')
        }, {
          name: 'address',
          label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Address', 'cb-identityjs2026'),
          type: 'textarea'
        }, {
          name: 'phone',
          label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Phone', 'cb-identityjs2026'),
...
/***/ "./blocks/contact-directory/block.json"
/*!*********************************************!*\
  !*** ./blocks/contact-directory/block.json ***!
  \*********************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"cb-identityjs2026/contact-directory","title":"CB Contact Directory","category":"cb-identityjs2026","icon":"id-alt","attributes":{"mode":{"type":"string","default":"emails"},"groups":{"type":"array","default":[]}},"supports":{"anchor":true,"className":true,"align":true,"color":{"text":false,"background":true,"gradient":false,"__experimentalSkipSerialization":true}},"editorScript":"file:./build/index.js","render":"file:./render.php"}');
...
(() => {
/*!***********************************************!*\
  !*** ./blocks/contact-directory/src/index.js ***!
  \***********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/blocks */ "@wordpress/blocks");
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./edit */ "./blocks/contact-directory/src/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../block.json */ "./blocks/contact-directory/block.json");
