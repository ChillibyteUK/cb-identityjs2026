...
/***/ "./blocks/child-page-nav/src/edit.js"
/*!*******************************************!*\
  !*** ./blocks/child-page-nav/src/edit.js ***!
  \*******************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
function Edit({
  ...
  const {
    ...
    return {
      pages: select(_wordpress_core_data__WEBPACK_IMPORTED_MODULE_4__.store).getEntityRecords('postType', 'page', query),
      hasResolved: select(_wordpress_core_data__WEBPACK_IMPORTED_MODULE_4__.store).hasFinishedResolution('getEntityRecords', ['postType', 'page', query])
    };
  }, []);
  const options = [{
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('— Select a page —', 'cb-identityjs2026'),
    value: 0
  }, ...(pages ?? []).map(page => ({
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)(_shared_EditorBlockShell__WEBPACK_IMPORTED_MODULE_5__["default"], {
    ...
    clientId: clientId,
    title: "CB Child Page Nav",
    textDomain: "cb-identityjs2026",
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Title', 'cb-identityjs2026'),
      value: title,
      help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('e.g. "SERVICES" — leave blank to hide the title bar entirely.', 'cb-identityjs2026'),
      onChange: value => setAttributes({
        title: value
      })
    }), !hasResolved ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Spinner, {}) : /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SelectControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Parent Page', 'cb-identityjs2026'),
      value: parentPage,
      options: options,
      help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Lists this page\'s children as nav items — e.g. the "Services" page for a services sub-nav.', 'cb-identityjs2026'),
      onChange: value => setAttributes({
        parentPage: Number(value)
      })
    })]
  });
}
...
/***/ "./blocks/child-page-nav/block.json"
/*!******************************************!*\
  !*** ./blocks/child-page-nav/block.json ***!
  \******************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"cb-identityjs2026/child-page-nav","title":"CB Child Page Nav","category":"cb-identityjs2026","icon":"list-view","attributes":{"parentPage":{"type":"number","default":0},"title":{"type":"string","default":""}},"supports":{"anchor":true,"className":true,"align":true},"editorScript":"file:./build/index.js","render":"file:./render.php"}');
...
(() => {
/*!********************************************!*\
  !*** ./blocks/child-page-nav/src/index.js ***!
  \********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/blocks */ "@wordpress/blocks");
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./edit */ "./blocks/child-page-nav/src/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../block.json */ "./blocks/child-page-nav/block.json");
