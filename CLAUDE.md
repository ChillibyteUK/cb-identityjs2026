...
inc/
  ...
  options.php           Site-Wide Settings page (plain Settings API, one array option) + cb_identityjs2026_get_setting()
...
setup.sh                One-time bootstrap for a NEW project checked out from this skeleton —
                        prompts for a theme name + slug, renames every cb-identityjs2026 /
                        CB Identity JS 2026 / cb_identityjs2026_ / CB_Identity_JS_2026_ reference, resets git to
